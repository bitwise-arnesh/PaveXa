...
export default async function AdminDashboardPage() {
  ...
  const [
    ...
    db
      ...
      .from(report)
      .where(eq(report.status, "UNDER_REVIEW")),
    ...
    db
      ...
      .from(report)
      .where(eq(report.status, "RESOLVED")),
    ...
    db
      ...
      .orderBy(desc(report.riskScore), desc(report.createdAt))
      .limit(8),
  ...
  const underReview = Number(underReviewResult[0]?.count ?? 0);

  const resolved = Number(resolvedResult[0]?.count ?? 0);

  const averageConfidenceDecimal = Number(confidenceResult[0]?.average ?? 0);

  const averageConfidence = averageConfidenceDecimal * 100;

  const activeReports = Number(activeReportsResult[0]?.count ?? 0);
  ...
  const stats = [
    ...
    },
    {
      ...
      value: highPriority,
      icon: AlertTriangle,
      description: "Critical or high risk",
    },
    {
      label: "Under review",
      value: underReview,
      ...
      <SidebarInset>
        <main className="min-h-screen bg-background text-foreground">
          ...
          <div className="sticky top-0 z-30 border-b border-border bg-background/90 backdrop-blur-xl">
            <div className="flex h-14 items-center justify-between px-4 sm:px-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold">PaveXa Command Center</p>
          ...
          <div className="mx-auto w-full max-w-[1500px] px-4 py-7 sm:px-6 lg:px-8 lg:py-9">
            ...
            <header id="dashboard" className="scroll-mt-24">
              <div className="flex flex-col justify-between gap-6 border-b border-border pb-7 xl:flex-row xl:items-end">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">
                    ...
                    . Monitor road reports, infrastructure risk and maintenance
            ...
            <section id="infrastructure-map" className="mt-7 scroll-mt-20">
              <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
                ...
                <AdminReportMap reports={activeMapReports} />
              </div>
            </section>
            ...
            <section id="reports" className="mt-7 scroll-mt-20">
              <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
                  ...
                  <div className="flex items-center justify-between border-b border-border px-5 py-4 sm:px-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-xs text-muted-foreground">
                          Highest-risk reports requiring attention.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex min-h-64 items-center justify-center px-6 text-center">
                      <div>
                        ...
                        <p className="mt-1 text-xs text-muted-foreground">
                          All reported infrastructure issues have been resolved.
                        </p>
                      </div>
                    </div>
                  ) : (
                ...
                <aside className="space-y-4">
                  ...
                  <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-semibold">Active reports</p>
                  ...
                  <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      ...
                      {totalReports.toLocaleString()} resolved
                    </p>
            ...
            <section id="ai-assistant" className="mt-7 scroll-mt-24">
              <AdminAiChat />
            </section>
